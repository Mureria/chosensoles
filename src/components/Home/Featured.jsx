...
const Featured = () => {
  return (
    <>
    <Container>
        <h1 className='text-2xl font-bold py-4 md:text-2xl'>Featured</h1>
        <div className='grid grid-cols-2 gap-4 md:grid-cols-4 lg:grid-cols-5'>
            {shoes.map((item)=>{
                return (
                    <div className='shadow-lg  hover:shadow-xl hover:-translate-y-1 ease-in-out duration-700 pb-4 rounded-md'>
                        <Link to='product'>
